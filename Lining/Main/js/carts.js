        ...
        let tmp = data.goods.map(item => {
            ...
            <ul class="order_lists order_item" gid=${item.good_id}>
                ...
                <li class="list_con">
                  ...
                  <div class="list_text"><a href="./detail.html?product/${item.good_id}">${item.name}</a></div>
                </li>
                <li class="list_price">
                ...
                <li class="list_sum">
                  <p class="sum_price" data-price=${item.price.slice(2)}>${Math.round(item.price.slice(2) * item.num * 100) / 100}</p>
                </li>
                <li class="list_op">
